...
class getConsole_Command_ConfigDebugService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Bundle\FrameworkBundle\Command\ConfigDebugCommand(($container->services['container.env_var_processors_locator'] ?? $container->load('getContainer_EnvVarProcessorsLocatorService')));

        $instance->setName('debug:config');
        $instance->setDescription('Dump the current configuration for an extension');

        return $container->privates['console.command.config_debug'] = $instance;
    }
}
