...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getRouterService($container)
    {
        ...
        return $container->services['router'] = $instance;
    }
    ...
    {
        $instance = \Symfony\Component\Routing\RequestContext::fromUri($container->getEnv('DEFAULT_URI'), 'localhost', 'http', 80, 443);

        $instance->setParameters(['_locale' => 'en']);

        return $container->privates['router.request_context'] = $instance;
    }
